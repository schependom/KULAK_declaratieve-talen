...
/* package Examen-0.1.0.0 */
#ifndef VERSION_Examen
#define VERSION_Examen "0.1.0.0"
#endif /* VERSION_Examen */
#ifndef MIN_VERSION_Examen
#define MIN_VERSION_Examen(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Examen */
...
#define CURRENT_COMPONENT_ID "Examen-0.1.0.0-inplace-Examen"
